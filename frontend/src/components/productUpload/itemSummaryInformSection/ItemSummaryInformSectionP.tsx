...
export default function ItemSummaryInformSection({
    ...
    if (field === "title") {
        await axios.post("/api/update-title", { id, title: value });
    } else if (field === "memo") {
        await axios.post("/api/update-memo", { id, memo: value });
    }
    };
                                    ...
                                    <div className="goods-details">
                                        <div className="goods-title">
                                            <TextInputWithButton
                                                ...
                                                onButtonClick={(value, fieldName) =>
                                                onModifySet?.(item.origin_goods_code || "", fieldName || "title", value)
                                                }
                                            />          
                                        </div>
                                        <div className="goods-memo">
                                            <TextInputWithButton
                                                ...
                                                onChange={(val) => handleTitleChange(item.origin_goods_code, val)}
                                                onButtonClick={(value, fieldName) =>
                                                onModifySet?.(item.origin_goods_code || "", fieldName || "memo", value)
                                                }
                                            />
                                        </div>
